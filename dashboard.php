...
<div class="container">
 ...
 <div class="tab-pane container fade" id="students">
    ...
    <button class="btn btn-primary" id="studentSearchBtn">
        <i class="fas fa-search"></i> <!-- FontAwesome search icon -->
    </button>
</div>
            <table class="table table-bordered">
...
$(document).ready(function(){
    $("#bookSearch").on("keyup", function(){
        ...
        $.ajax({
            url: "search_books.php", // Backend script to fetch search results
            method: "POST",
            data: { query: query },
            success: function(data){
                $("#bookTable").html(data); // Update the table dynamically
            }
        });
    });

    $("#searchBtn").click(function(){
        $("#bookSearch").trigger("keyup"); // Trigger search on button click
    });
});
</script>
...
$(document).ready(function(){
    $("#studentSearch").on("keyup", function(){
        ...
        $.ajax({
            url: "search_students.php", // Backend script to fetch search results
            method: "POST",
            data: { query: query },
            success: function(data){
                $("#studentTable").html(data); // Update the student table dynamically
            }
        });
    });

    $("#studentSearchBtn").click(function(){
        $("#studentSearch").trigger("keyup"); // Trigger search on button click
    });
});
</script>
